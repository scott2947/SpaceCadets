...
class Integer(Literal):
    ...
    def Addition(self, intVal):
        self.value += intVal.value

    def Subtraction(self, intVal):
        self.value -= intVal.value

    def Multiplication(self, intVal):
        self.value *= intVal.value

    def Divide(self, intVal):
        self.value = self.value // intVal.value
    
    def Modulo(self, intVal):
        self.value = self.value % intVal.value
...
class Interpreter():
    ...
    def Add(self, operands):
        obj1 = self.dataStructures[operands[:operands.find(" ")]]
        obj2 = self.dataStructures[operands[operands.find(" ") + 1:]]
        obj1.GetObject().Addition(obj2.GetObject())

    def Sub(self, operands):
        obj1 = self.dataStructures[operands[:operands.find(" ")]]
        obj2 = self.dataStructures[operands[operands.find(" ") + 1:]]
        obj1.GetObject().Subtraction(obj2.GetObject())

    def Mul(self, operands):
        obj1 = self.dataStructures[operands[:operands.find(" ")]]
        obj2 = self.dataStructures[operands[operands.find(" ") + 1:]]
        obj1.GetObject().Multiplication(obj2.GetObject())

    def Div(self, operands):
        obj1 = self.dataStructures[operands[:operands.find(" ")]]
        obj2 = self.dataStructures[operands[operands.find(" ") + 1:]]
        obj1.GetObject().Divide(obj2.GetObject())

    def Mod(self, operands):
        obj1 = self.dataStructures[operands[:operands.find(" ")]]
        obj2 = self.dataStructures[operands[operands.find(" ") + 1:]]
        obj1.GetObject().Modulo(obj2.GetObject())
